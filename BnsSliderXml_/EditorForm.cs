...
namespace BnsSliderXml_
{
    public partial class EditorForm : Form
    {
        ...
        void XmlRead(string xRace, string xSex)
        {
        ...
        void XmlWrite(string xFile, string xRace, string xSex)
        {
            XmlDocument xmlDoc = new XmlDocument();
            XmlReaderSettings settings = new XmlReaderSettings();
            settings.IgnoreComments = true;//  
            ...
            foreach (XmlNode xn in nodeList)// 
            {
                ...
                if (xe2.GetAttribute("race") == xRace && xe2.GetAttribute("sex") == xSex && xe2.GetAttribute("table-type") == "bodycustom")// 
                {
                    try
                    {
                        //max
                        xe2.SetAttribute("body-custom-max-1", txbPelvisWidMax.Text);
                        xe2.SetAttribute("body-custom-max-10", txbNekThicMax.Text);
                        xe2.SetAttribute("body-custom-max-11", txbNeckLenMax.Text);
                        xe2.SetAttribute("body-custom-max-12", txbShoulderHeiMax.Text);
                        xe2.SetAttribute("body-custom-max-13", txbShoulderWidMax.Text);
                        xe2.SetAttribute("body-custom-max-14", txbShoulderSizMax.Text);
                        xe2.SetAttribute("body-custom-max-15", txbArmThicMax.Text);
                        xe2.SetAttribute("body-custom-max-16", txbArmLenMax.Text);
                        xe2.SetAttribute("body-custom-max-17", txbHandSizMax.Text);
                        xe2.SetAttribute("body-custom-max-18", txbHandLenMax.Text);
                        xe2.SetAttribute("body-custom-max-19", txbFootSizMax.Text);
                        xe2.SetAttribute("body-custom-max-2", txbPelvisThickMax.Text);
                        xe2.SetAttribute("body-custom-max-20", txbBuildMax.Text);
                        xe2.SetAttribute("body-custom-max-21", txbHeigthMax.Text);
                        xe2.SetAttribute("body-custom-max-22", txbHeadSizMax.Text);
                        xe2.SetAttribute("body-custom-max-23", txbChestHeiMax.Text);
                        xe2.SetAttribute("body-custom-max-24", txbChestWidMax.Text);
                        xe2.SetAttribute("body-custom-max-25", txbChestSizMax.Text);
                        xe2.SetAttribute("body-custom-max-26", txbHeadWidMax.Text);
                        xe2.SetAttribute("body-custom-max-3", txbWaisThicMax.Text);
                        xe2.SetAttribute("body-custom-max-4", txbWaisLenMax.Text);
                        xe2.SetAttribute("body-custom-max-5", txbThigthWidMax.Text);
                        xe2.SetAttribute("body-custom-max-6", txbCalfWidMax.Text);
                        xe2.SetAttribute("body-custom-max-7", txbThighLenMax.Text);
                        xe2.SetAttribute("body-custom-max-8", txbCalfLenMax.Text);
                        xe2.SetAttribute("body-custom-max-9", txbTorsoSizMax.Text);
                        //min
                        xe2.SetAttribute("body-custom-min-1", txbPelvisWidMin.Text);
                        xe2.SetAttribute("body-custom-min-10", txbNekThicMin.Text);
                        xe2.SetAttribute("body-custom-min-11", txbNeckLenMin.Text);
                        xe2.SetAttribute("body-custom-min-12", txbShoulderHeiMin.Text);
                        xe2.SetAttribute("body-custom-min-13", txbShoulderWidMin.Text);
                        xe2.SetAttribute("body-custom-min-14", txbShoulderSizMin.Text);
                        xe2.SetAttribute("body-custom-min-15", txbArmThicMin.Text);
                        xe2.SetAttribute("body-custom-min-16", txbArmLenMin.Text);
                        xe2.SetAttribute("body-custom-min-17", txbHandSizMin.Text);
                        xe2.SetAttribute("body-custom-min-18", txbHandLenMin.Text);
                        xe2.SetAttribute("body-custom-min-19", txbFootSizMin.Text);
                        xe2.SetAttribute("body-custom-min-2", txbPelvisThickMin.Text);
                        xe2.SetAttribute("body-custom-min-20", txbBuildMin.Text);
                        xe2.SetAttribute("body-custom-min-21", txbHeigthMin.Text);
                        xe2.SetAttribute("body-custom-min-22", txbHeadSizMin.Text);
                        xe2.SetAttribute("body-custom-min-23", txbChestHeiMin.Text);
                        xe2.SetAttribute("body-custom-min-24", txbChestWidMin.Text);
                        xe2.SetAttribute("body-custom-min-25", txbChestSizMin.Text);
                        xe2.SetAttribute("body-custom-min-26", txbHeadWidMin.Text);
                        xe2.SetAttribute("body-custom-min-3", txbWaisThicMin.Text);
                        xe2.SetAttribute("body-custom-min-4", txbWaisLenMin.Text);
                        xe2.SetAttribute("body-custom-min-5", txbThigthWidMin.Text);
                        xe2.SetAttribute("body-custom-min-6", txbCalfWidMin.Text);
                        xe2.SetAttribute("body-custom-min-7", txbThighLenMin.Text);
                        xe2.SetAttribute("body-custom-min-8", txbCalfLenMin.Text);
                        xe2.SetAttribute("body-custom-min-9", txbTorsoSizMin.Text);
                    }
                    catch (Exception e)
                    {
                        MessageBox.Show(e.ToString());
